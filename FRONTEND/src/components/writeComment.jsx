    ...
    return (
        <form className="mt-14" onSubmit={handleSubmit}>
            ...
            <div class=" w-5xl flex items-center px-3 py-2 rounded-lg bg-gray-700">
                <textarea value={comment} onChange={handleChange} id="message" rows="1" class="block mx-4 p-2.5 w-full text-sm   rounded-lg border   bg-gray-800 border-gray-600 placeholder-gray-400 text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="Write a comment"></textarea>
