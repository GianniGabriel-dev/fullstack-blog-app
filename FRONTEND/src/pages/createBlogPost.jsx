      ...
      >
        <div className="mb-5">
          ...
          <input
            ...
            } text-sm rounded-lg   block w-full p-2.5 bg-gray-700 outline-none placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500`}
            placeholder="Title..."
          />
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            className={`border ${
              errors.messagePost ? "border-red-500" : "border-gray-600"
          ...
          />
          {errors.messagePost && (
            <p className="text-red-500">{errors.messagePost}</p>
          )}
        </div>
        <button
          type="submit"
